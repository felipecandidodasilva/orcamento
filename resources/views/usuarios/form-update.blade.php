                    ...
                    <form role="form" action=" {{ route($dadosPagina['rota'] . 'update', $user->id)}}" method="post">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="contato" value="{{$user->contato}}"
                                       name="contato">
                            </div>
                        </div>
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6 ">
                                ...
                                <input type='number' name="cnpj" value="{{ $user->cnpj}}" id="cnpj"
                                       class="form-control">
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type='data' name="nascimento" value="{{ $user->nascimento}}" id="nascimento"
                                       class="form-control">
                            </div>
                        </div>
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            <div class="form-group col-xs-12 ">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="1" id="fornecedor"
                                           name="fornecedor"
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="1" id="funcionario"
                                           name="funcionario"
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-3">
                                ...
                                <input type='text' name="cep" value="{{ $user->cep}}" id="postal_code"
                                       class="form-control">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-7">
                                ...
                                <input type='text' name="logradouro" value="{{ $user->logradouro}}" id=""
                                       class="form-control">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-2">
                                ...
                                <input type='text' name="numero" value="{{ $user->numero}}" id="numero"
                                       class="form-control">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-4 ">
                                ...
                                <input type='text' name="bairro" value="{{ $user->bairro}}" id="bairro"
                                       class="form-control">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-6 ">
                                ...
                                <input type='text' name="cidade" value="{{ $user->cidade}}" id="locality"
                                       class="form-control">
                            </div>
                        </div>
                        <div class="form-row">
